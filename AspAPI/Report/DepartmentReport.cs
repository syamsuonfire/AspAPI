...
namespace AspAPI.Report
{
    public class DepartmentReport
    {
        ...
        private void ReportHeader()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("My Department Name", _fontStyle));
        ...
        private void ReportBody()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("Tanggal Diperbaharui", _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfTable.AddCell(_pdfPCell);
            ...
            foreach (Department department in _departments)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(department.CreateDate.ToString("MM/dd/yyyy"), _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);

                _pdfPCell = new PdfPCell(new Phrase(department.UpdateDate.ToString("MM/dd/yyyy"), _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
